// src/pages/users/BestSellersPage.jsx
...
const BestSellersPage = () => {
  ...
  // Filter only products marked as bestseller
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-rose-50/20 rounded-2xl border border-dashed border-rose-200">
            ...
            <h3 className="text-lg font-serif text-gray-800 mb-1">No Best Sellers Found</h3>
            <p className="text-sm text-gray-500 mb-6">
              There are no products matching your criteria at the moment, or items haven't been marked as bestsellers yet.
            </p>
            <button
